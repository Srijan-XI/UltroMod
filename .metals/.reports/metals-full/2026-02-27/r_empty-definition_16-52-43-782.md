error id: file:///P:/CODE-XI/MincraftMods/Mod1/src/main/java/com/example/ultimatemod/screen/BackpackScreenHandler.java:net/minecraft/screen/ScreenHandlerType#
file:///P:/CODE-XI/MincraftMods/Mod1/src/main/java/com/example/ultimatemod/screen/BackpackScreenHandler.java
empty definition using pc, found symbol in pc: net/minecraft/screen/ScreenHandlerType#
empty definition using semanticdb
empty definition using fallback
non-local guesses:

offset: 333
uri: file:///P:/CODE-XI/MincraftMods/Mod1/src/main/java/com/example/ultimatemod/screen/BackpackScreenHandler.java
text:
```scala
